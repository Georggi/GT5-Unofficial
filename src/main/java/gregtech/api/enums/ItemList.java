...
public enum ItemList implements IItemContainer {
    ...
    Generator_Antimatter_Reactor, Magnetic_Confinement_Pod, Magnetic_Confinement_Pod_AntiHydrogen, Magnetic_Confinement_Pod_Hydrogen,
    ...
    Teleporter, Cover_NeedsMaintainance, Casing_Turbine, Casing_Turbine1, Casing_Turbine2, Casing_Turbine3, Casing_EngineIntake, Casing_Dyson_Ring, Casing_Core_Chamber,
    Casing_Coil_Cupronickel, Casing_Coil_Kanthal, Casing_Coil_Nichrome, Casing_Coil_TungstenSteel, Casing_Coil_HSSG, Casing_Coil_Naquadah, Casing_Coil_NaquadahAlloy, Casing_Coil_Magnetic, Casing_Internix_Chamber,
