...
public enum ItemList implements IItemContainer {
    ...
    Casing_Stripes_A, Casing_Stripes_B, Casing_RadioactiveHazard, Casing_BioHazard, Casing_ExplosionHazard, Casing_FireHazard, Casing_AcidHazard, Casing_MagicHazard, Casing_FrostHazard, Casing_NoiseHazard, Casing_Grate, Casing_Vent, Casing_Firebox_Bronze, Casing_Firebox_Steel, Casing_Firebox_TungstenSteel,
    ...
    Antimatter_Reactor, Magnetic_Confinement_Pod, Magnetic_Confinement_Pod_AntiHydrogen, Magnetic_Confinement_Pod_Hydrogen,
    Block_Magnetic_Coil, Casing_Internix_Chamber, Casing_Dyson_Ring, Casing_Core_Chamber, Casing_RadiationProof,
    ...
    public static Fluid sOilExtraHeavy, sEpichlorhydrin, sDrillingFluid, sNitricAcid, sBlueVitriol, sNickelSulfate, sToluene, sNitrationMixture, sRocketFuel, sHydricSulfur;
